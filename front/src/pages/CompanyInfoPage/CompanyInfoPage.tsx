  ...
  return (
    <div className="pageContent">
      ...
      <div style={{ marginTop: "40px" }}>
        ...
        <div className={classes.formatedText}>
          <div style={{ marginTop: 0 }}><h4 style={{ display: "inline" }}>Буква «D»</h4> – это так называемая «несуществующая фигура», один из видов оптических иллюзий, фигура, 
          ...
          <div><h4 style={{ display: "inline" }}>Буква «П»</h4> – как символ Пермского края, подчеркивает, что компания родом из Перми, отсылая нас к логотипу Перми 
