...
export function TapeImg(props: SvgIconProps) {
  return (
    <SvgIcon {...props} style={{ width: "126px", height: "28px"}}>
      ...
      <rect x="4" y="-0.308594" width="126" height="28" fill="#383838" fillOpacity="0.05" shape-rendering="crispEdges"/>
      </g>
      <defs>
      <filter id="filter0_bd_128_436" x="0.9" y="-3.30859" width="132.2" height="35.1" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
